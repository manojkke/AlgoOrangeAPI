import groq  # Correcting the import for Groq
...
class Orchestrator:
    ...
    async def route_query(self, userChatQuery: str, chatHistory: str):
        ...
        client = groq.Client(api_key="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")  # Replace with your actual API key
